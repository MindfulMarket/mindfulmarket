  ...
  return (
    <div className="page">
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <Card style={{ display: 'flex', flex: 1, width: '400' }} name="$10 or less" imageUrl="https://comps.canstockphoto.com/cheap-grunge-red-round-stamp-drawings_csp16503597.jpg" button={null} brand={{}} category="home" />
        <Card style={{ display: 'flex', flex: 1 }} name="Sping Cleaning Items" imageUrl="http://www.sustainablebabysteps.com/images/xspring-cleaning-tips.jpg.pagespeed.ic.09GQFP7PeA.jpg" button={null} brand={{}} category="home" />
